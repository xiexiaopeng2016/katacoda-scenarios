odoo.define('odoo_prototyper_inspect.InnerChatter', function (require) {
    "use strict";
    ...
    var innerChatter = Widget.extend({
        ...
        init: function (parent, record, mailFields, options) {
            ...
            if (mailFields.mail_thread) {
                ...
                // listform 也需要显示chatter
                var nodeOptions = this.record.fieldsInfo[record.viewType][mailFields.mail_thread].options;
        ...
        start: function () {
            ...
            // if (parent) {
            //     this.$record_bar = parent.record_bar;
            //     var self = this;
            //
            //     // render and append the buttons
            //     $.when(self.$record_bar.append(QWeb.render('innerChatter.Buttons', {
            //         new_message_btn: !!this.fields.thread,
            //         log_note_btn: this.hasLogButton,
            //         schedule_activity_btn: !!this.fields.activity,
            //         isMobile: config.device.isMobile,
            //     }))).then(function () {
            //         self.$record_bar.on('click', '.o_chatter_button_new_message', function () {
            //             self.do_show();
            //             self._onOpenComposerMessage();
            //         });
            //         self.$record_bar.on('click', '.o_chatter_button_log_note', function () {
            //             self._onOpenComposerNote();
            //         });
            //         self.$record_bar.on('click', '.o_chatter_button_schedule_activity', function () {
            //             self._onScheduleActivity();
            //         });
            //         self.$record_bar.on('click', '.toggle_chatter', function () {
            //             self.do_toggle();
            //         });
            //     });
            // }
        ...
        _render: function (def) {
            ...
            return def.then(function () {
                ...
                if (self.fields.followers) {
                    self.fields.followers.$el.appendTo(self.$record_bar);
                }

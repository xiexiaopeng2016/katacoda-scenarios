...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['backbone', 'lodash', 'jquery'], function (Backbone, _2, $) {

            Backbone.$ = $;

            return factory(root, Backbone, _2, $);
        });
        ...
        module.exports = factory(root, Backbone, _2, $);
        ...
        root.joint = factory(root, Backbone, _2, $);
        root.g = root.joint.g;
        root.V = root.Vectorizer = root.joint.V;
    }

}(this, function (root, Backbone, _2, $) {
...
// Global namespace.
    ...
    var joint = {
        ...
        util: {
            ...
            supplement: _2.defaults,

            // Same as `mixin()` but deep version.
            deepMixin: _2.mixin,

            // Same as `supplement()` but deep version.
            deepSupplement: _2.defaultsDeep,
            ...
            sortedIndex: _2.sortedIndexBy || _2.sortedIndex,
            uniq: _2.uniqBy || _2.uniq,
            uniqueId: _2.uniqueId,
            sortBy: _2.sortBy,
            isFunction: _2.isFunction,
            result: _2.result,
            union: _2.union,
            invoke: _2.invokeMap || _2.invoke,
            difference: _2.difference,
            intersection: _2.intersection,
            omit: _2.omit,
            pick: _2.pick,
            has: _2.has,
            bindAll: _2.bindAll,
            ...
            defaultsDeep: _2.defaultsDeep,
            isPlainObject: _2.isPlainObject,
            isEmpty: _2.isEmpty,
            isEqual: _2.isEqual,
            noop: function () {
            },
            cloneDeep: _2.cloneDeep,
            toArray: _2.toArray,
            flattenDeep: _2.flattenDeep,
            camelCase: _2.camelCase,
            groupBy: _2.groupBy,
            forIn: _2.forIn,
            without: _2.without,
            debounce: _2.debounce,
            clone: _2.clone,
            ...
            merge: function () {
                if (_2.mergeWith) {
                    ...
                    return _2.mergeWith.apply(this, args)
                }
                return _2.merge.apply(this, arguments);
            }
        }
    };
    ...
    joint.mvc.View = Backbone.View.extend({
        ...
        _setAttributes: function (attrs) {
            if (this.svgElement) {
                this._setElement(joint.util.result(this, 'el'));
                this.vel.attr(attrs);
            } else {
                this.$el.attr(attrs);
            }
...
// --------------------------
    ...
    joint.dia.Cell = Backbone.Model.extend({
        ...
        // instead of just _2.extend. The reason is that we want to mixin attributes set in upper classes.
        constructor: function (attributes, options) {
            ...
            if ((defaults = joint.util.result(this, 'defaults'))) {
                //<custom code>
                // Replaced the call to _2.defaults with joint.util.merge.
        ...
        toJSON: function () {
            ...
            //var attributes = JSON.parse(JSON.stringify(_2.omit(this.attributes, 'attrs')));
...
// ----------------------------------------
    ...
    joint.dia.LinkView = joint.dia.CellView.extend({
        ...
        initialize: function (options) {
            ...
            // `_2.labelCache` is a mapping of indexes of labels in the `this.get('labels')` array to
...
// Usage:
// joint.shapes.custom.MyElementWithPorts = joint.shapes.basic.Path.extend(_2.extend({}, joint.shapes.basic.PortsModelInterface, {
...
//         attrs[portBodySelector] = { port: { id: portName || _2.uniqueId(type) , type: type } };
...
//}));
    joint.shapes.basic.PortsModelInterface = {
        ...
        initialize: function () {
            ...
            this.constructor.__super__2.constructor.__super__2.initialize.apply(this, arguments);
        },

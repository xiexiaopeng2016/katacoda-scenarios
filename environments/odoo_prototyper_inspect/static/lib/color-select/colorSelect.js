(function ($) {
    ...
    $.fn.colorSelect = function () {
        ...
        // invokes the createGroup method, treating the select element like an optgroup.
        // Then changes the class to container.
        ...
        function createGroup(parent) {
            ...
            var group = $('<div class="color-select-optgroup ' + classname + '" />');
        ...
        function createOption(option) {
            ...
            return $('<div class="color-select-option" />')
                ...
                // when clicked on the div, change the select element's value.
                // this will then invoke the select.change() mehtod.
                .click(function () {
                    if (multiple) {
                        select.find('option[value="' + color + '"]').prop('selected', function (i, v) {
                            return !v;
                        });
                    }
                    else {
